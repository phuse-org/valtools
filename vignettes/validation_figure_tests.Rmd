...
{valtools} extends automated testing first introduced by {testthat} to make validation easier. Here we will give a short demo on how to short-circuit these sorts tests to make our own figure validation paradigm.
