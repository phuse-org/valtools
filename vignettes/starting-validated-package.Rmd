...
You can add them into the documentation of the package via `vt_add_user_to_config()`.
...
Now that this persons information is recorded, you can construct the test code
...
- Release Details: 
    ...
    - Traceability table to show which requirements are being met by which test cases
...
Keep in mind, the report is an Rmarkdown, so there is no limit to editing and customization.
